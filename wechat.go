...
import (
	...
	"github.com/misu99/wechat/v2/cache"
	"github.com/misu99/wechat/v2/miniprogram"
	miniConfig "github.com/misu99/wechat/v2/miniprogram/config"
	"github.com/misu99/wechat/v2/officialaccount"
	offConfig "github.com/misu99/wechat/v2/officialaccount/config"
	"github.com/misu99/wechat/v2/openplatform"
	openConfig "github.com/misu99/wechat/v2/openplatform/config"
	"github.com/misu99/wechat/v2/pay"
	payConfig "github.com/misu99/wechat/v2/pay/config"
	"github.com/misu99/wechat/v2/util"
	"github.com/misu99/wechat/v2/work"
	workConfig "github.com/misu99/wechat/v2/work/config"
)
